...
public class StudentController {
    ...
    public String createStudent(Model theModel){
    ...
    public String saveStudent(@ModelAttribute("student")Student student) {//Bind the student to the object
        studentService.saveStudent(student);
        return "redirect:/students" ; //Redirect to students page
    }
    @GetMapping("/students/edit/{id}") //PathVariable to get the id
